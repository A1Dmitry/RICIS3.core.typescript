...
export const KNOWN_SINGULARITY_PROBLEMS: ProblemNode[] = [
  ...
  {
    "id": "real-catalog-55",
    "title": "Равенство классов P и NP",
    "description": "Главная проблема теории сложности.",
    "state": "unresolved",
    "type": "scientific_task",
    "targetFunction": "Formalize(РавенствоклассовPиNP)",
    "zoneIds": [
      "informatics"
    ],
    "dependencyIds": [],
    ...
    "rewardClass": "reputation",
    "prizeNote": "Catalog discovery",
    "singularityHint": "Экспоненциальный взрыв времени вычисления."
  },
  {
    "id": "real-catalog-56",
  ...
  {
    "id": "real-catalog-59",
    "title": "Сложность факторизации",
    "description": "Разложение чисел (основа RSA).",
    "state": "unresolved",
    "type": "core_singularity",
    "targetFunction": "Formalize(Сложностьфакторизации)",
    "zoneIds": [
      "informatics"
    ],
    "dependencyIds": [],
    ...
    "rewardClass": "reputation",
    "prizeNote": "Catalog discovery",
    "singularityHint": "Сингулярность времени квантового алгоритма Шора."
  },
  {
    "id": "real-catalog-60",
  ...
  {
    "id": "real-catalog-66",
    "title": "Сложность задачи изоморфизма графов",
    "description": "Квазиполиномиальное время.",
    "state": "unresolved",
    "type": "scientific_task",
    "targetFunction": "Formalize(Сложностьзадачиизоморфизмаграфов)",
    "zoneIds": [
      "informatics"
    ],
    "dependencyIds": [],
    ...
    "rewardClass": "reputation",
    "prizeNote": "Catalog discovery",
    "singularityHint": "Аномальная граница сложности."
  },
  {
    "id": "real-catalog-67",
    "title": "NP-полные задачи",
    "description": "Задача коммивояжера, SAT.",
    "state": "unresolved",
    "type": "core_singularity",
    "targetFunction": "Formalize(NPполныезадачи)",
    "zoneIds": [
      "informatics"
    ],
    "dependencyIds": [
    ...
    "rewardClass": "reputation",
    "prizeNote": "Catalog discovery",
    "singularityHint": "Комбинаторный взрыв."
  },
  {
    "id": "real-catalog-68",
